...
const Inputs = ({setQuery,setUnits}) => {
  ...
  return (
    <div className="flex flex-row justify-center my-6">
      <div className="flex flex-row w-3/4 items-center justify-evenly space-x-4">
        <input type="text" placeholder="Search by city..." 
        value={city}
        onChange={(e) => setCity(e.currentTarget.value)}
        className="text-gray-500
         text-xl font-light p-2 w-full shadow-xl
         capitilize focus:outline-none placeholder:lowercase "/>
        <CiSearch  size={30} 
